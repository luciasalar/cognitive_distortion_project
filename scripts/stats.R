...
#compute emotion score  sum/num.post
...
#per post 
label_emo$negative_emo_score2  <- label_emo$negative_score/label_emo$post_count
#per day score
label_emo$negative_emo_score3  <- label_emo$negative_score/60
...
##per day value, intead of per post
