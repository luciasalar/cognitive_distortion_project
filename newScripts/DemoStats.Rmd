...
users <- read.csv('/home/lucia/phd_work/mypersonality_data/cognitive_distortion/data/important_data/twoM_newLabels80P.csv')
...
#write.csv(data, '/home/lucia/phd_work/mypersonality_data/cognitive_distortion/data/important_data/FinalSampleUsers.csv')
...
stats <- function (data){
  ttest<- wilcox.test(data ~ both$group, data=data) 
  print(ttest)

}

stats_result <- lapply(data, function(x) stats(x))
